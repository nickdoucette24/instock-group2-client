...
const InventoryPage = () => {
  ...
  if (location.pathname.endsWith(`add`)) return <AddInventoryItem url={url} setUpdating={setUpdating} />;
  if (location.pathname.endsWith(`edit`)) return <EditInventoryItem url={url} setUpdating={setUpdating} />;
